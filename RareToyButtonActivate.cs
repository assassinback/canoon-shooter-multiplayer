...
public class RareToyButtonActivate : MonoBehaviour {
	...
	void Update () {
		if (slider.GetComponent<AchievementsRareToys>().claim==true) {
	...
	{
		slider.GetComponent<AchievementsRareToys> ().claim = false;
		PlayerPrefs.SetInt ("PlayerXP",PlayerPrefs.GetInt ("PlayerXP")+slider.GetComponent<AchievementsRareToys>().RewardXP);
