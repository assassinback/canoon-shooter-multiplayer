...
public class create1v1 : MonoBehaviour
{
    ...
    {
        PhotonNetwork.JoinOrCreateRoom(joina.text, new RoomOptions() { MaxPlayers = 2 }, TypedLobby.Default);
    }
    ...
    {
        PhotonNetwork.CreateRoom(genRandom(), new RoomOptions() { MaxPlayers = 2 }, null);
    }
