...
public class createffa : MonoBehaviour
{
    ...
    {
        PhotonNetwork.CreateRoom(Create.text, new RoomOptions() { MaxPlayers = 3 }, null);
    }
    public void onclickjoin()
    {
        PhotonNetwork.JoinOrCreateRoom(joina.text, new RoomOptions() { MaxPlayers = 3 }, TypedLobby.Default);
    }
    ...
    {
        PhotonNetwork.CreateRoom(genRandom(), new RoomOptions() { MaxPlayers = 3 }, null);
    }
